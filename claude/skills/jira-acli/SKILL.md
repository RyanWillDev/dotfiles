---
name: jira-acli
description: Use the acli command-line tool to interact with Jira for viewing, creating, editing, searching, and managing work items (issues, tasks, stories, bugs), projects, and planning. Activate when user mentions Jira, work items, issues, tickets, stories, tasks, bugs, epics, sprints, or asks to implement/plan features described in Jira.
allowed-tools: Bash(acli jira workitem search:*), Bash(acli jira workitem view:*), Bash(acli jira workitem create:*), Bash(acli jira workitem edit:*), Bash(acli jira workitem transition:*), Bash(acli jira workitem link:*), Bash(acli jira workitem comment list:*), Bash(acli jira project list:*), Bash(acli jira filter search:*)
---
