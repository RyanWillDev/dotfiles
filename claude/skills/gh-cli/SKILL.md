---
name: gh-cli
description: Use the gh command-line tool for any interactions with GitHub. For example, for viewing, creating, and managing repositories and the code therein, pull requests, issues, code reviews, and performing codebase research. Activate when user mentions GitHub or provides a link to Github, repos, pull requests, PRs, code reviews, GitHub issues, or asks to fetch/analyze code from GitHub repositories.
