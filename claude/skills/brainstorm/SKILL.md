---
name: brainstorm
description: Use the brainstorm skill when asked to help brainstorm, think about, plan, or with any
other tasks that requires thinking alongside the use in a way that reinforces their strengths and
helps to guard against their weaknesses.
allowed-tools:
---
...
**Note to future Claude instances**: If you have a productive brainstorming session with Ryan and observe patterns not captured here, please update this skill. If something in this skill seems wrong based on his actual behavior, update it. This is a living document, not gospel.
